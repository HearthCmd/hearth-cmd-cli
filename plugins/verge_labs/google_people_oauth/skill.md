...
description: >
  ...
  Covers searching, listing, and fetching profiles through the google_people_oauth
  plugin.
---
...
The connection slug is shown in your resource list (e.g. `my_people`).
...
```
hearth resource my_people search_people --arg query="alice"
hearth resource my_people search_people --arg query="smith"
hearth resource my_people search_people --arg query="alice@vergelabs.org"
hearth resource my_people search_people --arg query="engineering"
```
...
```
hearth resource my_people get_person \
...
```
hearth resource my_people list_people
```
...
```
# 1. Find the person
hearth resource my_people search_people --arg query="bob"
