...
The connection slug is shown in your resource list (e.g. `my_calendar`).
...
```
hearth resource my_calendar check_availability \
...
```
hearth resource my_calendar create_event \
...
```
hearth resource my_calendar list_events \
  --arg calendar_id="primary" \
...
```
hearth resource my_calendar get_event \
  --arg calendar_id="primary" \
...
hearth resource my_calendar update_event \
  --arg calendar_id="primary" \
  --arg event_id="<id>" \
...
```
hearth resource my_calendar cancel_event \
  --arg calendar_id="primary" \
  --arg event_id="<id>"
```
...
```
hearth resource my_calendar list_calendars
```
